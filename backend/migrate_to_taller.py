...
def migrate_to_taller_model():
    """
    Migra los datos existentes para implementar el modelo Taller.
    """
    print("🚀 Iniciando migración al modelo Taller...")
    ...
    with Session(engine) as session:
        try:
            ...
            for user in workshop_users:
                ...
                print(f"✅ Creado taller '{taller.nombre_comercial}' para usuario {user.username}")
